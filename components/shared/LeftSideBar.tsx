...
const LeftSideBar = () => {
  ...
  return (
    ...
    left-0 top-0 flex h-screen flex-col justify-between overflow-auto
    border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden
    lg:w-[266px] custom-scrollbar"
    >
